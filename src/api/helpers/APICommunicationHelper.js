...
//        console.log('response = ' + JSON.stringify(response.data))
        ...
        console.log('in catch, error data = ' + JSON.stringify(e.response.data))
        console.log('in catch, error status = ' + e.response.status)
        console.log('in catch, error headers = ' + e.response.headers)
