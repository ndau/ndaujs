...
module.exports.testSingleAddressData = {
...
module.exports.testAddressData = {
...
module.exports.testAddressDataRoot = {
...
module.exports.eaiValueForDisplayResponse = [
  {
...
module.exports.testMarketPrice = {
...
module.exports.setValidationTxRes = {
  fee_napu: 0
}

module.exports.lockTxRes = {
  fee_napu: 0
}

module.exports.notifyTxRes = {
  fee_napu: 0
}

module.exports.transferTxRes = {
  fee_napu: 0
}

module.exports.delegateTxRes = {
  fee_napu: 0
}

module.exports.setRewardsDestinationTxRes = {
  fee_napu: 0
}

module.exports.accountHistoryRes = {
  Items: [
    {
      Balance: constants.QUANTA_PER_UNIT * 1000,
...
module.exports.transactionByHashRes = {
  Tx: {
